    ...
    public partial class frmVehicleAdd : Form
    {
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string sql_insert = "insert into vehicle values ('" + txtReg.Text + "','" + txtModel.Text + "','" + txtType.Text + "'," +
               "'" + txtDay.Text + "','" + txtWeek.Text + "','" + txtMonth.Text + "','" + txtDriver.Text + "')";
        ...
        //    try
        //    {
        //        string sql_retrieve = "select * from vehicle where reg_no = '" + txtReg.Text + "'";
        ...
        //         ", rt_driver = '" + txtDriver.Text + "' where reg_no = '" + txtReg.Text + "' ";
